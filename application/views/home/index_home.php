<div class="konten">
    <div class="slider">
        <img src="<?php echo base_url(); ?>assets/images/banner-IA.jpg" width="624" height="326">
    </div>
    <div class="anggota">
...
<div class="konten">
    ...
    <div class="anggota">
        ...
        <ul>
            <?php foreach ($artikel as $kategori) { ?>
                <li>
                    <a href="<?php echo base_url(); ?>home/read/<?php echo $list['slug']; ?>"><?php echo ['judul']?></a>
                </li>
            <?php } ?>
        </ul>
    </div>
